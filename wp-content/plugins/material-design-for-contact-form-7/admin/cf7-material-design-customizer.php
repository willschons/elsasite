...
class CF7_Material_Design_Customizer
{
    ...
    public function customize_register( $wp_customize )
    {
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'cf7md_options[button_hover_on_dark]', array(
            'label'    => 'Button hover colour (dark theme)',
            'section'  => 'cf7md_options',
        ...
        $wp_customize->add_control( 'cf7md_options[text_hint_on_light]', array(
            ...
            'description' => '1 = black, 0 = transparent, default = 0.5',
            'input_attrs' => array(
            'min'  => 0,
            'max'  => 1,
            'step' => 0.01,
        ...
        $wp_customize->add_control( 'cf7md_options[text_hint_on_dark]', array(
            ...
            'description' => '1 = white, 0 = transparent, default = 0.72',
            'input_attrs' => array(
            'min'  => 0,
            'max'  => 1,
            'step' => 0.01,
        ...
        $wp_customize->add_control( 'cf7md_options[base_font_size]', array(
            ...
            'description' => 'Resize labels, help text etc. Text inputs and select fields can not be resized except by changing the font-size of your html tag, which is recommended to be set at 16px.',
        ) );
        // Font family
