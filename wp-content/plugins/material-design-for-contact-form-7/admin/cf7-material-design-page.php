				...
				<div class="cf7md-content">
					<div class="mdc-card" style="margin-bottom: 30px;">
						<div class="cf7md-card-header">
							<h4 class="cf7md-card-title">Plugin Settings</h4>
						</div>
						<div class="cf7md-card-body mdc-layout-grid">
							<div class="mdc-layout-grid__inner">
								<div class="cf7md-item cf7md-switch-pre-prepared mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
									<label class="cf7md-label cf7md-label--static">Legacy styles</label>
					...
					<div class="mdc-card" style="margin-bottom: 20px;">
						<div class="cf7md-card-header">
							<h4 class="cf7md-card-title">Quick Start</h4>
							<p class="cf7md-card-subtitle">Fastest track to a working form</p>
						</div>
					...
					<p><a class="mdc-button mdc-button--raised" href="https://wordpress.org/support/plugin/material-design-for-contact-form-7/reviews/?rate=5#new-post" target="_blank">Leave a 5 star review</a></p>
				</div>
				...
				<div class="cf7md-aside">
					<?php if( $this->fs->is_free_plan() ) : ?>
						<div class="mdc-card" style="margin-bottom: 32px;">
							<div class="cf7md-card-header">
								<h2 class="cf7md-card-title cf7md-card-title--large">Upgrade to Pro for <?php echo $this->upgrade_cost; ?></h2>
								<p class="cf7md-card-subtitle">And unlock all these extra features</p>
							</div>
							<div class="cf7md-card--slideshow">
								...
								<div class="cf7md-card--slide">
									...
									<div class="mdc-card__supporting-text cf7md-card-body">
										<p>Turn checkboxes into <a href="https://material.io/guidelines/components/selection-controls.html#selection-controls-switch" target="_blank">switches</a> using <code>[md-switch]</code>.</p>
									</div>
								</div>
								<div class="cf7md-card--slide">
									<div class="mdc-card__media mdc-card__media--img">
					...
					<?php else: ?>
						<div class="mdc-card" style="margin-bottom: 32px;">
							<div class="cf7md-card-header">
								<h2 class="cf7md-card-title cf7md-card-title--large">You have the pro version</h2>
								<p class="cf7md-card-subtitle">Start using pro features now!</p>
							</div>
							<div class="cf7md-card-body">
