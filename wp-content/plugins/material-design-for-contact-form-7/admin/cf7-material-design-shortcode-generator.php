...
class CF7_Material_Design_Shortcode_Generator {
	...
	public function get_state() {
		...
		$outlined_attr = array(
			...
			'default'  => '',
			'label'    => 'Outlined',
			'options'  => array( 'yes' => 'Use outlined variant' ),
			'renderer' => 'toggle'
		);
		$display_attr = array(
			'name'     => 'display',
		...
		array_push( $md_text['attributes'], $label_attr, $help_attr, $outlined_attr, $desktopwidth_attr, $tabletwidth_attr, $mobilewidth_attr );
		...
		array_push( $md_select['attributes'], $label_attr, $help_attr, $outlined_attr, $desktopwidth_attr, $tabletwidth_attr, $mobilewidth_attr );
		...
		$md_switch = array(
			'name'        => 'Switch',
			'description' => 'Turn checkboxes into switches.',
			'type'        => 'md-switch',
			'attributes'  => array(),
			'wraps'       => array( 'checkbox' ),
			'locked'      => $cf7md_fs->is_free_plan()
		...
		$md_quiz = array(
			...
			'attributes'  => array(
				array (
					...
					'label'    => 'Label',
					'renderer' => 'text',
					'help'     => 'This label will appear above the field. The quiz question will appear in the floating label.'
				)
			),
			'wraps'       => array( 'quiz' )
		);
		...
		$md_submit = array(
			...
			'attributes'  => array(
				array(
					...
					'label'    => 'Button style',
					'renderer' => 'radio',
					'options'  => array( 'raised' => 'Raised', 'unelevated' => 'Unelevated', 'outlined' => 'Outlined' ),
					'help'     => ''
				)
			),
	...
	public static function render_text_field( $field, $index ) {
		...
		<div class="cf7md-item">
			<div class="mdc-text-field">
				<input type="text" id="<?php echo esc_attr($field['name']); ?>" class="mdc-text-field__input" data-attr-index="<?php echo esc_attr($index); ?>" autocomplete="off" <?php echo (isset($field['required']) && $field['required']) ? 'required' : ''; ?>>
