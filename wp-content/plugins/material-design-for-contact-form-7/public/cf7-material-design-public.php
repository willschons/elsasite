...
class CF7_Material_Design
{
    ...
    public function md_text_shortcode( $atts, $content = '' )
    {
        ...
        $modifiers .= ( $leading_icon ? ' mdc-text-field--with-leading-icon' : '' );
        $modifiers .= ( $trailing_icon ? ' mdc-text-field--with-trailing-icon' : '' );
        ob_start();
        ?>
    ...
    public function md_select_shortcode( $atts, $content = '' )
    {
        ...
        //$modifiers .= $leading_icon ? ' mdc-select--with-leading-icon' : '';
        //$modifiers .= $trailing_icon ? ' mdc-select--with-trailing-icon' : '';
        ob_start();
        ?>
		<div class="<?php 
        echo  esc_attr( $class ) ;
